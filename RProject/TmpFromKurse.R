...
my_vector <- rnorm(17)
my_vector[sample(1:17, 10)] <- NA # на дес€ть случайных позиций поместим NA
...
model <- lm(sr ~ (.)^2, LifeCycleSavings)# . значит сумму по всем переменным, квадрат делает ещЄ и взаимодействи€ до второго уровн€
summary(model)
