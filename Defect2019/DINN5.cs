...
namespace Defect2019
{
    public partial class DINN5 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
             case   "15":
                    РабКонсоль.NodesCount = МатКлассы.FuncMethods.DefInteg.GaussKronrod.NodesCount.GK15;
                    break;
                case "21":
                    РабКонсоль.NodesCount = МатКлассы.FuncMethods.DefInteg.GaussKronrod.NodesCount.GK21;
                    break;
                case "31":
                    РабКонсоль.NodesCount = МатКлассы.FuncMethods.DefInteg.GaussKronrod.NodesCount.GK31;
                    break;
                case "41":
                    РабКонсоль.NodesCount = МатКлассы.FuncMethods.DefInteg.GaussKronrod.NodesCount.GK41;
                    break;
                case "51":
                    РабКонсоль.NodesCount = МатКлассы.FuncMethods.DefInteg.GaussKronrod.NodesCount.GK51;
                    break;
                case "61":
